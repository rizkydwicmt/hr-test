...
var config1 = {
  type: "doughnut",
  data: {
    labels: ["kategori1", "kategori2", "kategori3", "kategori4", "kategori5", "kategori6", "kategori7"],
    datasets: [
      { 
        label: "Balance",
        backgroundColor: "#fff",
        borderColor: "#fff",
        data: [48,134,132,74,21,11,20],
        fill: false,
        pointBorderWidth: 50,
        ...
        backgroundColor: ['#00CFDD', '#5A8DEE', '#FF5A5C', '#FF5B5C', '#FF5B5C', '#FF5C5C', '#FF5D5C'],
      },
    ],
  },
  options: {
...
var radialBarsOptions = {
  ...
  labels: ["Course", "Teacher", "Student", "Berries"],
};
